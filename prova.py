...
def decodecolor(atribut):
   ...
   return (coloret[bright][atribut & 0b00000111], coloret[bright][(atribut & 0b00111000)>>3])

def renderline(lienzo, y, adr_pattern):
...
pygame.init()
screen = pygame.display.set_mode((256*4, 200*4))
pygame.display.set_caption("Hello World")
surface = pygame.Surface((256, 200))
renderscreen1(surface)
surfacegran = pygame.transform.scale(surface, (256*4, 200*4))
screen.blit(surfacegran, (0, 0))
pygame.display.flip()

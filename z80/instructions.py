...
#            print q, ops
    ...
    def inc_hl_(instruction, registers):
        hl = registers.HL
        new = add8_nocarry(io.ZXmem[hl], 1, 0)
        io.ZXmem[hl] = new
    ...
    def inc_i_(instruction, registers, i, d):
        ...
        new = add8_nocarry(io.ZXmem[pos], 1, 0)
        io.ZXmem[pos] = new
